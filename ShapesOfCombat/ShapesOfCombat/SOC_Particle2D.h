...
#ifndef SOC_PARTICLE2D_H
#define SOC_PARTICLE2D_H

#include "SOC_VectorMath.h"
#include "SOC_ObjectType.h"
#include "SOC_CollisionHull2D.h"

class SOC_Particle2D
{
public:
    SOC_Particle2D()
    {
    ...
    SOC_Particle2D(float newPosX, float newPosY,float newRot, float newMass)
    {
